...
ActiveRecord::Schema[8.0].define(version: 2025_05_02_002759) do
  ...
  create_table "staff_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["staff_group_id"], name: "index_staff_users_on_staff_group_id"
  end
  ...
  add_foreign_key "staff_users", "staff_groups"
end
